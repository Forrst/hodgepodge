...
_pwd = "Today123"
# _geter = ["linyun.zhu@juniorchina.com"]
...
src = "https://t.financialdatamining.com/news/19/hk_strategy_{}.html".format(now.strftime("%Y%m%d"))
des = os.getcwd()+"/"+'尊嘉金融–{}年{}月{}日（周{}）港股市场分析报告.pdf'.format(now.year,now.month,now.day,weekday[now.weekday()])
...
filename = "尊嘉金融–{}年{}月{}日（周{}）港股市场分析报告.pdf".format(now.year,now.month,now.day,weekday[now.weekday()])
attachment.add_header('Content-Disposition', 'attachment', filename=Header(filename,'utf-8').encode())

subject = "尊嘉金融 – {}年{}月{}日（周{}）港股市场分析报告".format(now.year,now.month,now.day,weekday[now.weekday()])


filelist = ["img/header.png","img/gz_erweima.png","img/xz_erweima.png"]


title = "{}年{}月{}日港股开市汇报".format(now.year,now.month,now.day)
title_en = "Hong Kong Stock Market Report of {}".format(now.strftime("%Y/%m/%d"))
...
url = "https://t.financialdatamining.com/news/19/hk_strategy_{}.html".format(now.strftime("%Y%m%d"))
				...
				<tr>
					<td>
						<table width="672" border="0" align="center" cellpadding="0" cellspacing="0" >
							...
							<tr>
								<td valign="top" style="font-size:16px; line-height: 40px; color: #252D36; text-align: left; font-weight:400;">报告详情：点击链接<a href="{}" style="color: #02A4D2; text-decoration: none;">港股行情回顾与后市策略</a>，或下载附件PDF文档查看。</td>
							</tr>
							<tr>
								<td valign="top" style="font-size:14px; line-height: 18px; color: #7F8286; text-align: left; font-weight:400;">Details of Report：click the following link <a href="{}" style="color: #02A4D2;text-decoration: none;">Hong Kong Stock Market Review & Trading Strategy for Reference</a>, or download the attached PDF file for details.</td>
							</tr>
						</table>
					</td>
				</tr>
